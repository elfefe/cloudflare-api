from cloudflare.endpoint.endpoint import Endpoint
...
class Dns(Endpoint):
    ...
    def set_update(self, identifier, content, name, record_type, ttl=None, proxied=None, comment=None, tag=None):
    ...
    class Update(Endpoint.Update):
        def __init__(self, identifier, content, name, record_type, ttl=None, proxied=None, comment=None, tag=None):
